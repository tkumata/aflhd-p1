...
- (void)viewDidLoad {
    ...
    foodSeed = @[@"つみれ", @"つくね", @"オムライス", @"ハヤシライス", @"〇〇ラーメン", @"ピザ", @"○○サラダ", @"肉じゃが", @"ビーフストロガノフ", @"ドリア", @"そば", @"うどん", @"カレー", @"ハンバーグ", @"グラタン", @"スパゲッティ", @"シチュー", @"こんにゃく", @"こんぶ", @"だいこん", @"じゃが芋", @"たろ芋", @"さと芋", @"トマト", @"玉ネギ", @"長ネギ", @"エシャロット", @"ピーマン", @"にんじん", @"きゅうり", @"なす", @"しいたけ", @"鶏肉", @"豚肉", @"牛肉", @"セロリ", @"カリフラワー", @"ブロッコリー", @"ベビーコーン", @"わらび", @"チンゲンサイ", @"からし菜", @"あした葉", @"アーティチョーク", @"クウシンサイ", @"かぼちゃ", @"そら豆", @"えんどう豆", @"だだ茶豆", @"しめじ", @"エリンギ", @"まいたけ", @"キャベツ", @"ほうれん草", @"甘エビ", @"いか", @"ホタテ", @"イワシ", @"アジ", @"サンマ", @"マグロ", @"サバ", @"カツオ", @"りんご", @"みかん", @"バナナ", @"かき", @"メロン", @"スイカ", @"なし", @"ぶどう", @"イチゴ", @"アケビ", @"オレンジ"];
    
    kansouSeed = @[@"びっくりした", @"おいしかった", @"また食べたい", @"同じ食材で他のが食べてみたい", @"ごちそうさま", @"ありがとう", @"じぶんでつくってみたい"];
